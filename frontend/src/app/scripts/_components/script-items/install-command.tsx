...
function getInstallCommand(scriptPath = "", isAlpine = false, useGitea = false) {
  const githubUrl = `https://raw.githubusercontent.com/picu63/${basePath}/main/${scriptPath}`;
  const giteaUrl = `https://git.community-scripts.org/picu63/${basePath}/raw/branch/main/${scriptPath}`;
