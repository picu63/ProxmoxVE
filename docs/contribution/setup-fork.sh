...
git remote add upstream https://github.com/picu63/ProxmoxVE.git
...
# upstream   https://github.com/picu63/ProxmoxVE.git (fetch)
# upstream   https://github.com/picu63/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/picu63/ProxmoxVE"
echo ""
